          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="w-full appearance-none px-4 py-2 bg-white/20 text-white border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <option value="" className="text-black">Select a category</option>
                <option value="web3" className="text-black">Web3 / Smart Contracts</option>
                <option value="ai" className="text-black">AI / Data</option>
                <option value="climate" className="text-black">Climate / Carbon</option>
                <option value="design" className="text-black">Design / Creative</option>
                <option value="strategy" className="text-black">Consulting / Strategy</option>
              </select>
