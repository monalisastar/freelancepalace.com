...
export default function Hero() {
  return (
    <section className="relative w-full h-screen overflow-hidden text-white flex items-center justify-center">
      ...
      >
        <source src="/videos/flr-hero.mp4.mp4" type="video/mp4" />
      </video>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          ...
          <Button
            variant="outline"
            className="px-6 py-3 text-lg text-white border-white/60 hover:bg-white/10 hover:text-blue-300 backdrop-blur-md rounded-xl transition"
          >
            Explore Our Certifications
          </Button>
          <Link href="/flr-trust/whitepaper">
            <Button
              variant="ghost"
              className="text-sm text-blue-400 hover:text-blue-200 transition underline"
            >
              Read the Whitepaper →
            </Button>
          </Link>
